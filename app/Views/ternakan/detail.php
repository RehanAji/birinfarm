...
<?= $this->section('title') ?>Ternakan Kenari ||<?=$config->title_web?><?= $this->endSection() ?>
<?= $this->section('main_menu') ?>Ternakan Kenari<?= $this->endSection() ?>
<?= $this->section('main_breadcrumb') ?> <!--breadcrumb-->
  <li><a href="/">Home</a></li>
  <li><a href="/ternakan">Ternakan</a></li>
  <li><a href="/ternakan/kenari">Kenari</a></li>

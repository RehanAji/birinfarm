                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="<?= base_url('/be_artikel/') ?>">Artikel</a>
                                <a class="nav-link" href="<?= base_url('/be_produk/') ?>">Produk</a>
                                <a class="nav-link" href="<?= base_url('/be_galeri/') ?>">Galeri</a>
                                <a class="nav-link" href="<?= base_url('/be_verifikasiproduk/') ?>">Verifikasi Produk</a>
                            </nav>
                        </div>
